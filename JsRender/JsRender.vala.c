...
static void g_cclosure_user_marshal_VOID__JS_RENDER_NODE_STRING (GClosure * closure, GValue * return_value, guint n_param_values, const GValue * param_values, gpointer invocation_hint, gpointer marshal_data);
...
static void g_cclosure_user_marshal_VOID__JS_RENDER_NODE_STRING (GClosure * closure, GValue * return_value, guint n_param_values, const GValue * param_values, gpointer invocation_hint, gpointer marshal_data) {
	typedef void (*GMarshalFunc_VOID__JS_RENDER_NODE_STRING) (gpointer data1, gpointer arg_1, const char* arg_2, gpointer data2);
	register GMarshalFunc_VOID__JS_RENDER_NODE_STRING callback;
...
#line 10 "/home/alan/gitlive/app.Builder.js/JsRender/JsRender.vala"
	callback = (GMarshalFunc_VOID__JS_RENDER_NODE_STRING) (marshal_data ? marshal_data : cc->callback);
#line 10 "/home/alan/gitlive/app.Builder.js/JsRender/JsRender.vala"
	callback (data1, js_render_value_get_node (param_values + 1), g_value_get_string (param_values + 2), data2);
...
#line 10 "/home/alan/gitlive/app.Builder.js/JsRender/JsRender.vala"
	g_signal_new ("changed", JS_RENDER_TYPE_JS_RENDER, G_SIGNAL_RUN_LAST, 0, NULL, NULL, g_cclosure_user_marshal_VOID__JS_RENDER_NODE_STRING, G_TYPE_NONE, 2, JS_RENDER_TYPE_NODE, G_TYPE_STRING);
