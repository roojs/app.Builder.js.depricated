...
public class Xcls_MainWindow : Object 
{
    ...
    public class Xcls_topbarmenu : Object 
    {
        ...
        public Xcls_topbarmenu(Xcls_MainWindow _owner )
        {
            ...
            child_0.ref();
            this.el.reorder_child (  child_0.el , ?int? );
        }
    ...
    public class Xcls_mainpane : Object 
    {
        ...
        public Xcls_mainpane(Xcls_MainWindow _owner )
        {
            ...
            var child_1 = new Xcls_VBox13( _this );
            child_1.ref();
    ...
    public class Xcls_about : Object 
    {
        ...
        public Xcls_about(Xcls_MainWindow _owner )
        {
            ...
            // set gobject values
            var child_0 = new Xcls_Actor71( _this );
            child_0.ref();
            this.el.add_child (  child_0.el  );
    ...
    public class Xcls_Actor71 : Object 
    {
        public GtkClutter.Actor el;
        private Xcls_MainWindow  _this;
        ...
        // ctor 
        public Xcls_Actor71(Xcls_MainWindow _owner )
        {
            _this = _owner;
            this.el = new GtkClutter.Actor();
