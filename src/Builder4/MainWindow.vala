...
public class Xcls_MainWindow : Object 
{
    ...
    public class Xcls_mainpane : Object 
    {
        ...
        public Xcls_mainpane(Xcls_MainWindow _owner )
        {
            ...
            var child_1 = new Xcls_VBox12( _this );
            child_1.ref();
    ...
    public class Xcls_VBox12 : Object 
    {
        public Gtk.VBox el;
        private Xcls_MainWindow  _this;
        ...
        // ctor 
        public Xcls_VBox12(Xcls_MainWindow _owner )
        {
            _this = _owner;
            this.el = new Gtk.VBox( true, 0 );
    ...
    public class Xcls_new_window : Object 
    {
        ...
        public Xcls_new_window(Xcls_MainWindow _owner )
        {
            ...
            // set gobject values
            var child_0 = new Xcls_Actor66( _this );
            child_0.ref();
            this.el.add_child (  child_0.el  );
    ...
    public class Xcls_Actor66 : Object 
    {
        public GtkClutter.Actor el;
        private Xcls_MainWindow  _this;
        ...
        // ctor 
        public Xcls_Actor66(Xcls_MainWindow _owner )
        {
            _this = _owner;
            this.el = new GtkClutter.Actor();
    ...
    public class Xcls_Button67 : Object 
    {
        ...
        // ctor 
        public Xcls_Button67(Xcls_MainWindow _owner )
        {
            _this = _owner;
            this.el = new Gtk.Button();
    ...
    public class Xcls_about : Object 
    {
        ...
        public Xcls_about(Xcls_MainWindow _owner )
        {
            ...
            // set gobject values
            var child_0 = new Xcls_Actor70( _this );
            child_0.ref();
            this.el.add_child (  child_0.el  );
    ...
    public class Xcls_Actor70 : Object 
    {
        public GtkClutter.Actor el;
        private Xcls_MainWindow  _this;
        ...
        // ctor 
        public Xcls_Actor70(Xcls_MainWindow _owner )
        {
            _this = _owner;
            this.el = new GtkClutter.Actor();
