...
static void __lambda64_ (Xcls_WindowAddPropXcls_TreeView2* self, GtkTreePath* path, GtkTreeViewColumn* column);
gchar* xcls_windowaddprop_xcls_model_getValue (Xcls_WindowAddPropXcls_model* self, GtkTreeIter* iter, gint col);
static void ___lambda64__gtk_tree_view_row_activated (GtkTreeView* _sender, GtkTreePath* path, GtkTreeViewColumn* column, gpointer self);
...
static void ___lambda64__gtk_tree_view_row_activated (GtkTreeView* _sender, GtkTreePath* path, GtkTreeViewColumn* column, gpointer self) {
#line 131 "/home/alan/gitlive/app.Builder.js/Builder4/WindowAddProp.vala"
	__lambda64_ ((Xcls_WindowAddPropXcls_TreeView2*) self, path, column);
...
#line 131 "/home/alan/gitlive/app.Builder.js/Builder4/WindowAddProp.vala"
	_tmp18_ = self->el;
#line 131 "/home/alan/gitlive/app.Builder.js/Builder4/WindowAddProp.vala"
	g_signal_connect_object (_tmp18_, "row-activated", (GCallback) ___lambda64__gtk_tree_view_row_activated, self, 0);
#line 98 "/home/alan/gitlive/app.Builder.js/Builder4/WindowAddProp.vala"
