...
static gboolean __lambda114_ (Xcls_EditProject* self, GtkWidget* _self_, GdkEventAny* event);
static gboolean ___lambda114__gtk_widget_destroy_event (GtkWidget* _sender, GdkEventAny* event, gpointer self);
static void __lambda115_ (Xcls_EditProject* self, GtkDialog* _self_, gint id);
...
static void ___lambda115__gtk_dialog_response (GtkDialog* _sender, gint response_id, gpointer self);
...
static gboolean ___lambda114__gtk_widget_destroy_event (GtkWidget* _sender, GdkEventAny* event, gpointer self) {
	gboolean result;
	result = __lambda114_ (self, _sender, event);
#line 59 "/home/alan/gitlive/app.Builder.js/Builder4/EditProject.vala"
	return result;
...
static void __lambda115_ (Xcls_EditProject* self, GtkDialog* _self_, gint id) {
	...
	Xcls_EditProjectXcls_dir* _tmp11_;
	...
	gchar* _tmp23_ = NULL;
	gchar* fn;
	Xcls_EditProject* _tmp24_;
	Xcls_EditProjectXcls_xtype* _tmp25_;
	gchar* _tmp26_ = NULL;
	gchar* _tmp27_;
	const gchar* _tmp28_;
...
static void ___lambda115__gtk_dialog_response (GtkDialog* _sender, gint response_id, gpointer self) {
#line 63 "/home/alan/gitlive/app.Builder.js/Builder4/EditProject.vala"
	__lambda115_ (self, _sender, response_id);
...
Xcls_EditProject* xcls_editproject_construct (GType object_type) {
	...
	GtkDialog* _tmp7_;
	GtkDialog* _tmp8_;
	Xcls_EditProjectXcls_VBox2* _tmp9_;
	Xcls_EditProjectXcls_VBox2* child_0;
	GtkDialog* _tmp10_;
	GtkBox* _tmp11_ = NULL;
	GtkVBox* _tmp12_;
	Xcls_EditProjectXcls_Button9* _tmp13_;
	Xcls_EditProjectXcls_Button9* child_1;
	GtkDialog* _tmp14_;
	GtkButton* _tmp15_;
	Xcls_EditProjectXcls_Button10* _tmp16_;
...
#line 59 "/home/alan/gitlive/app.Builder.js/Builder4/EditProject.vala"
	_tmp19_ = self->el;
#line 59 "/home/alan/gitlive/app.Builder.js/Builder4/EditProject.vala"
	g_signal_connect ((GtkWidget*) _tmp19_, "destroy-event", (GCallback) ___lambda114__gtk_widget_destroy_event, self);
#line 63 "/home/alan/gitlive/app.Builder.js/Builder4/EditProject.vala"
	_tmp20_ = self->el;
#line 63 "/home/alan/gitlive/app.Builder.js/Builder4/EditProject.vala"
	g_signal_connect (_tmp20_, "response", (GCallback) ___lambda115__gtk_dialog_response, self);
#line 34 "/home/alan/gitlive/app.Builder.js/Builder4/EditProject.vala"
...
Xcls_EditProjectXcls_VBox2* xcls_editproject_xcls_vbox2_construct (GType object_type) {
	...
	GtkVBox* _tmp0_;
	Xcls_EditProjectXcls_HBox3* _tmp1_;
	Xcls_EditProjectXcls_HBox3* child_0;
	GtkVBox* _tmp2_;
	GtkHBox* _tmp3_;
	Xcls_EditProjectXcls_dir* _tmp4_;
...
Xcls_EditProjectXcls_HBox3* xcls_editproject_xcls_hbox3_construct (GType object_type) {
	...
	GtkHBox* _tmp0_;
	Xcls_EditProjectXcls_Label4* _tmp1_;
	Xcls_EditProjectXcls_Label4* child_0;
	GtkHBox* _tmp2_;
	GtkLabel* _tmp3_;
	Xcls_EditProjectXcls_xtype* _tmp4_;
