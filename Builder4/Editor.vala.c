...
Xcls_Editor* xcls_editor_construct (GType object_type) {
	...
	GtkWindow* _tmp6_;
	GtkWindow* _tmp7_;
	Xcls_EditorXcls_VBox2* _tmp8_;
	Xcls_EditorXcls_VBox2* child_0;
	GtkWindow* _tmp9_;
	GtkVBox* _tmp10_;
	GtkWindow* _tmp11_;
	GtkWindow* _tmp12_;
...
Xcls_EditorXcls_VBox2* xcls_editor_xcls_vbox2_construct (GType object_type) {
	...
	GtkVBox* _tmp0_;
	Xcls_EditorXcls_Toolbar3* _tmp1_;
	Xcls_EditorXcls_Toolbar3* child_0;
	GtkVBox* _tmp2_;
	GtkToolbar* _tmp3_;
	Xcls_EditorXcls_RightEditor* _tmp4_;
...
Xcls_EditorXcls_Toolbar3* xcls_editor_xcls_toolbar3_construct (GType object_type) {
	...
	GtkToolbar* _tmp0_;
	Xcls_EditorXcls_save_button* _tmp1_;
...
Xcls_EditorXcls_RightEditor* xcls_editor_xcls_righteditor_construct (GType object_type) {
	...
	Xcls_Editor* _tmp1_;
	Xcls_EditorXcls_RightEditor* _tmp2_;
