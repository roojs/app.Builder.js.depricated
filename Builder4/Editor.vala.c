...
static void __lambda76_ (Xcls_EditorXcls_save_button* self);
...
static gboolean __lambda78_ (Xcls_EditorXcls_view* self, GdkEventKey* event);
static gboolean ___lambda78__gtk_widget_key_release_event (GtkWidget* _sender, GdkEventKey* event, gpointer self);
...
static void __lambda77_ (Xcls_EditorXcls_buffer* self);
static void ___lambda77__gtk_text_buffer_changed (GtkTextBuffer* _sender, gpointer self);
...
Xcls_Editor* xcls_editor_construct (GType object_type) {
	...
	gchar* _tmp5_;
	Xcls_Editor* _tmp6_;
	Xcls_EditorXcls_HBox2* _tmp7_;
	Xcls_EditorXcls_HBox2* child_0;
	GtkVBox* _tmp8_;
	GtkHBox* _tmp9_;
	Xcls_Editor* _tmp10_;
	Xcls_EditorXcls_RightEditor* _tmp11_;
...
gboolean xcls_editor_saveContents (Xcls_Editor* self) {
	...
	Xcls_Editor* _tmp0_;
	Xcls_EditorXcls_buffer* _tmp1_;
	gchar* _tmp2_ = NULL;
	gchar* str;
	Xcls_Editor* _tmp3_;
	Xcls_EditorXcls_buffer* _tmp4_;
	gboolean _tmp5_ = FALSE;
	Xcls_Editor* _tmp6_;
	Xcls_Editor* _tmp7_;
	Xcls_EditorXcls_save_button* _tmp8_;
	GtkButton* _tmp9_;
	const gchar* _tmp10_;
...
void xcls_editor_show (Xcls_Editor* self, JsRenderNode* node, const gchar* ptype, const gchar* key) {
	...
	gchar* val;
	const gchar* _tmp7_;
	Xcls_EditorXcls_view* _tmp16_;
	const gchar* _tmp17_;
	Xcls_EditorXcls_key_edit* _tmp18_;
	GtkEntry* _tmp19_;
	const gchar* _tmp20_;
...
Xcls_EditorXcls_HBox2* xcls_editor_xcls_hbox2_construct (GType object_type, Xcls_Editor* _owner) {
	...
	GtkButton* _tmp6_;
	Xcls_Editor* _tmp7_;
	Xcls_EditorXcls_key_edit* _tmp8_;
	Xcls_EditorXcls_key_edit* child_1;
	GtkHBox* _tmp9_;
	GtkEntry* _tmp10_;
...
Xcls_EditorXcls_key_edit* xcls_editor_xcls_key_edit_construct (GType object_type, Xcls_Editor* _owner) {
	...
	Xcls_Editor* _tmp1_;
	Xcls_Editor* _tmp2_;
	Xcls_EditorXcls_key_edit* _tmp3_;
	GtkEntry* _tmp4_;
...
#line 1139 "Editor.vala.c"
	} else {
#line 280 "/home/alan/gitlive/app.Builder.js/Builder4/Editor.vala"
		_tmp0_ = FALSE;
#line 1143 "Editor.vala.c"
	}
#line 280 "/home/alan/gitlive/app.Builder.js/Builder4/Editor.vala"
	_tmp5_ = _tmp0_;
#line 280 "/home/alan/gitlive/app.Builder.js/Builder4/Editor.vala"
	if (_tmp5_) {
#line 1149 "Editor.vala.c"
		Xcls_Editor* _tmp6_;
...
#line 282 "/home/alan/gitlive/app.Builder.js/Builder4/Editor.vala"
		_tmp6_ = self->priv->_this;
#line 282 "/home/alan/gitlive/app.Builder.js/Builder4/Editor.vala"
		xcls_editor_saveContents (_tmp6_);
...
#line 278 "/home/alan/gitlive/app.Builder.js/Builder4/Editor.vala"
	_tmp15_ = self->el;
#line 278 "/home/alan/gitlive/app.Builder.js/Builder4/Editor.vala"
	g_signal_connect_object ((GtkWidget*) _tmp15_, "key-release-event", (GCallback) ___lambda78__gtk_widget_key_release_event, self, 0);
#line 252 "/home/alan/gitlive/app.Builder.js/Builder4/Editor.vala"
...
void xcls_editor_xcls_view_load (Xcls_EditorXcls_view* self, const gchar* str) {
	...
	GtkSourceView* _tmp15_;
	Xcls_Editor* _tmp16_;
	Xcls_EditorXcls_save_button* _tmp17_;
	GtkButton* _tmp18_;
...
#line 354 "/home/alan/gitlive/app.Builder.js/Builder4/Editor.vala"
	_tmp5_ = self->el;
#line 354 "/home/alan/gitlive/app.Builder.js/Builder4/Editor.vala"
	g_signal_connect_object ((GtkTextBuffer*) _tmp5_, "changed", (GCallback) ___lambda77__gtk_text_buffer_changed, self, 0);
#line 343 "/home/alan/gitlive/app.Builder.js/Builder4/Editor.vala"
	return self;
#line 1504 "Editor.vala.c"
}
