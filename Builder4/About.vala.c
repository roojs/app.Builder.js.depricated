...
static void __lambda27_ (Xcls_AboutDialog1* self, gint rid);
static void ___lambda27__gtk_dialog_response (GtkDialog* _sender, gint response_id, gpointer self);
static gboolean __lambda28_ (Xcls_AboutDialog1* self, GtkWidget* _self_, GdkEventAny* event);
...
static gboolean ___lambda28__gtk_widget_delete_event (GtkWidget* _sender, GdkEventAny* event, gpointer self) {
	gboolean result;
	result = __lambda28_ (self, _sender, event);
#line 49 "/home/alan/gitlive/app.Builder.js/Builder4/About.vala"
	return result;
...
#line 45 "/home/alan/gitlive/app.Builder.js/Builder4/About.vala"
	_tmp8_ = self->el;
#line 45 "/home/alan/gitlive/app.Builder.js/Builder4/About.vala"
	g_signal_connect ((GtkDialog*) _tmp8_, "response", (GCallback) ___lambda27__gtk_dialog_response, self);
#line 49 "/home/alan/gitlive/app.Builder.js/Builder4/About.vala"
	_tmp9_ = self->el;
#line 49 "/home/alan/gitlive/app.Builder.js/Builder4/About.vala"
	g_signal_connect ((GtkWidget*) _tmp9_, "delete-event", (GCallback) ___lambda28__gtk_widget_delete_event, self);
#line 29 "/home/alan/gitlive/app.Builder.js/Builder4/About.vala"
	return self;
