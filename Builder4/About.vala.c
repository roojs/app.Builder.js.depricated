...
static gboolean __lambda11_ (About* self, GtkWidget* _self_, GdkEventAny* event);
static gboolean ___lambda11__gtk_widget_delete_event (GtkWidget* _sender, GdkEventAny* event, gpointer self);
static void __lambda12_ (About* self, gint rid);
...
static gboolean ___lambda11__gtk_widget_delete_event (GtkWidget* _sender, GdkEventAny* event, gpointer self) {
	gboolean result;
	result = __lambda11_ ((About*) self, _sender, event);
#line 35 "/home/alan/gitlive/app.Builder.js/Builder4/About.vala"
	return result;
...
#line 40 "/home/alan/gitlive/app.Builder.js/Builder4/About.vala"
	__lambda12_ ((About*) self, response_id);
