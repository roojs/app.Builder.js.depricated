...
static void __lambda56_ (Xcls_RightPaleteXcls_TreeView4* self, GdkDragContext* ctx);
static void ___lambda56__gtk_widget_drag_begin (GtkWidget* _sender, GdkDragContext* context, gpointer self);
static void __lambda57_ (Xcls_RightPaleteXcls_TreeView4* self, GdkDragContext* drag_context, GtkSelectionData* selection_data, guint info, guint time);
...
static void __lambda58_ (Xcls_RightPaleteXcls_TreeView4* self, GdkDragContext* drag_context);
static void ___lambda58__gtk_widget_drag_end (GtkWidget* _sender, GdkDragContext* context, gpointer self);
static gboolean __lambda59_ (Xcls_RightPaleteXcls_TreeView4* self, GdkEventButton* event);
...
static void ___lambda57__gtk_widget_drag_data_get (GtkWidget* _sender, GdkDragContext* context, GtkSelectionData* selection_data, guint info, guint time_, gpointer self) {
#line 218 "/home/alan/gitlive/app.Builder.js/Builder4/WindowRightPalete.vala"
	__lambda57_ ((Xcls_RightPaleteXcls_TreeView4*) self, context, selection_data, info, time_);
...
static gboolean ___lambda59__gtk_widget_button_press_event (GtkWidget* _sender, GdkEventButton* event, gpointer self) {
	gboolean result;
	result = __lambda59_ ((Xcls_RightPaleteXcls_TreeView4*) self, event);
#line 239 "/home/alan/gitlive/app.Builder.js/Builder4/WindowRightPalete.vala"
	return result;
