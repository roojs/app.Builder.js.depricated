...
static gboolean __lambda46_ (Xcls_StandardErrorDialog* self, GtkWidget* _self_, GdkEventAny* event);
static gboolean ___lambda46__gtk_widget_delete_event (GtkWidget* _sender, GdkEventAny* event, gpointer self);
static void __lambda47_ (Xcls_StandardErrorDialog* self, GtkDialog* _self_, gint response_id);
static void ___lambda47__gtk_dialog_response (GtkDialog* _sender, gint response_id, gpointer self);
...
static gboolean ___lambda46__gtk_widget_delete_event (GtkWidget* _sender, GdkEventAny* event, gpointer self) {
	gboolean result;
	result = __lambda46_ ((Xcls_StandardErrorDialog*) self, _sender, event);
#line 42 "/home/alan/gitlive/app.Builder.js/Builder4/StandardErrorDialog.vala"
	return result;
...
static void ___lambda47__gtk_dialog_response (GtkDialog* _sender, gint response_id, gpointer self) {
#line 47 "/home/alan/gitlive/app.Builder.js/Builder4/StandardErrorDialog.vala"
	__lambda47_ ((Xcls_StandardErrorDialog*) self, _sender, response_id);
...
#line 42 "/home/alan/gitlive/app.Builder.js/Builder4/StandardErrorDialog.vala"
	_tmp5_ = self->el;
#line 42 "/home/alan/gitlive/app.Builder.js/Builder4/StandardErrorDialog.vala"
	g_signal_connect ((GtkWidget*) _tmp5_, "delete-event", (GCallback) ___lambda46__gtk_widget_delete_event, self);
#line 47 "/home/alan/gitlive/app.Builder.js/Builder4/StandardErrorDialog.vala"
	_tmp6_ = self->el;
#line 47 "/home/alan/gitlive/app.Builder.js/Builder4/StandardErrorDialog.vala"
	g_signal_connect ((GtkDialog*) _tmp6_, "response", (GCallback) ___lambda47__gtk_dialog_response, self);
#line 29 "/home/alan/gitlive/app.Builder.js/Builder4/StandardErrorDialog.vala"
	return self;
