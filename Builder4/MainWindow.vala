...
public class Xcls_MainWindow : Object 
{
    ...
    public class Xcls_objectshowbutton : Object 
    {
        ...
        public Xcls_objectshowbutton(Xcls_MainWindow _owner )
        {
            ...
            // set gobject values
            this.el.reactive = true;
            var child_0 = new Xcls_Text28( _this );
            child_0.ref();
            this.el.add_child (  child_0.el  );
            var child_1 = new Xcls_Actor29( _this );
            child_1.ref();
            this.el.add_child (  child_1.el  );
    ...
    public class Xcls_Text28 : Object 
    {
        ...
        private Xcls_MainWindow  _this;
            ...
            // ctor 
        public Xcls_Text28(Xcls_MainWindow _owner )
        {
            _this = _owner;
    ...
    public class Xcls_addpropbutton : Object 
    {
        ...
        public Xcls_addpropbutton(Xcls_MainWindow _owner )
        {
            ...
            // set gobject values
            this.el.reactive = true;
            var child_0 = new Xcls_Text32( _this );
            child_0.ref();
            this.el.add_child (  child_0.el  );
            var child_1 = new Xcls_Actor33( _this );
            child_1.ref();
            this.el.add_child (  child_1.el  );
    ...
    public class Xcls_Text32 : Object 
    {
        public Clutter.Text el;
        private Xcls_MainWindow  _this;
            ...
            // ctor 
        public Xcls_Text32(Xcls_MainWindow _owner )
        {
            _this = _owner;
    ...
    public class Xcls_addlistenerbutton : Object 
    {
        ...
        public Xcls_addlistenerbutton(Xcls_MainWindow _owner )
        {
            ...
            // set gobject values
            this.el.reactive = true;
            var child_0 = new Xcls_Text36( _this );
            child_0.ref();
            this.el.add_child (  child_0.el  );
            var child_1 = new Xcls_Actor37( _this );
            child_1.ref();
            this.el.add_child (  child_1.el  );
    ...
    public class Xcls_Text36 : Object 
    {
        public Clutter.Text el;
        private Xcls_MainWindow  _this;
            ...
            // ctor 
        public Xcls_Text36(Xcls_MainWindow _owner )
        {
            _this = _owner;
    ...
    public class Xcls_addprojectbutton : Object 
    {
        ...
        public Xcls_addprojectbutton(Xcls_MainWindow _owner )
        {
            ...
            // set gobject values
            this.el.reactive = true;
            var child_0 = new Xcls_Text40( _this );
            child_0.ref();
            this.el.add_child (  child_0.el  );
            var child_1 = new Xcls_Actor41( _this );
            child_1.ref();
            this.el.add_child (  child_1.el  );
    ...
    public class Xcls_Text40 : Object 
    {
        public Clutter.Text el;
        private Xcls_MainWindow  _this;
            ...
            // ctor 
        public Xcls_Text40(Xcls_MainWindow _owner )
        {
            _this = _owner;
