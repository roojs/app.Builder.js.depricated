...
static gboolean __lambda15_ (Xcls_DialogTemplateSelect* self, GtkWidget* _self_, GdkEventAny* event);
...
static gboolean ___lambda15__gtk_widget_delete_event (GtkWidget* _sender, GdkEventAny* event, gpointer self) {
	gboolean result;
	result = __lambda15_ ((Xcls_DialogTemplateSelect*) self, _sender, event);
#line 52 "/home/alan/gitlive/app.Builder.js/Builder4/DialogTemplateSelect.vala"
	return result;
