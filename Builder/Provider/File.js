...
Builder.Provider.File = function(cfg) {
...
Roo.extend(Builder.Provider.File, Roo.Observable , {
    ...
    toJsonArray : function()
    {
        var ret = { }; 
        var _this = this;
        Roo.each(['id', 'name', 'parent', 'title', 'path'], function(k) {
            ret[k] = _this[k];
        },this);
        return ret;
    },
            ...
            switch(typeof(v)) {
                ...
                case 'object': 
                    if (v.constructor == Array) {
                        ...
                        ret += ix + this.arrayToJsString(v, ind+1);
                        return;
                    }
                
                    ret += ix + this.objectToJsString(v, ind+1);
                    return;
