...
Builder.Provider.Project = function(cfg) {
    ...
    this.on('changed' , function() {
        ...
        Builder.Provider.ProjectManager.fireEvent('changed', _this);
    });
    Roo.apply(this, cfg);
    ...
    if (this.files ){
        for (var f in this.files) {
            this.files[f] = new Builder.Provider.File[this.xtype](this.files[f]);
        }
    }
...
Roo.extend(Builder.Provider.Project, Roo.Observable,  {
    id : false,
    fn:  false,
    paths : false,
    files : false,
    ...
    toJSON : function()
    {
        var ret = { };
        var _this = this;
        Roo.each(['id', 'fn', 'paths', 'xtype', 'name'], function(k) {
            ret[k] = _this[k];
    ...
    {
        return  new Builder.Provider.File[this.xtype]({
            path : path,
            parent : ''
        });
    },
    ...
    scanDir : function(dir, dp) 
    {
        ...
        while (true) {
            ...
            this.files[dir  + '/' + fn] = new Builder.Provider.File[this.xtype]({
                path : dir  + '/' + fn,
                parent : parent
            });
            /*
