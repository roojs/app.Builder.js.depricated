...
Builder.Provider.File.Gtk = function(cfg) {
    ...
    this.cn = [];
    */
    Builder.Provider.File.Gtk.superclass.constructor.call(this, cfg);
...
Roo.extend(Builder.Provider.File.Gtk, Builder.Provider.File,   {
